...
output = load_dataloaders("data_no_noise.pt")
...
training_stuff = train_npe_model(model, optim, 100, train_loader, val_loader, patience=15, scheduler=sched, model_path='best_dingo_model_no_noise.pt')
...
# Load best model
model, _ = load_npe("best_dingo_model_no_noise.pt")
