...
# Set to a path from GenerateDataset.py to skip data generation.
# Leave as None to generate (and optionally cache) data on each run.
    ...
    print("="*70 + "\n")
        ...
        if DATASET_PATH:
            ...
            def _all_tensors(loader):
                Xs, ys = [], []
                for b in loader: Xs.append(b[0]); ys.append(b[1])
