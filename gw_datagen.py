...
from o4_psd import build_o4_psd_cache, load_random_o4_psd, _DEFAULT_CACHE, _DEFAULT_N_SEGS
...
def pycbc_data_generator(config: Dict[str, Callable],
    ...
    for chunk_idx in range(num_chunks):
        ...
        chunk_results = _generate_waveforms_parallel(
            chunk_params, time_resolution, approximant, f_lower, num_workers, show_progress, detectors, target_length, add_noise, f_final, highpass_fc
        )
...
def pycbc_massive_gravity_data_generator(config: Dict[str, Callable],
    ...
    for chunk_idx in range(num_chunks):
        ...
        chunk_results = _generate_modified_waveforms_parallel(
            ...
            add_noise, lambda_g, f_final, highpass_fc
        )
